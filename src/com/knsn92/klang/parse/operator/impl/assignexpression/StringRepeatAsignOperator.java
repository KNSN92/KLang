...
public class StringRepeatAsignOperator extends AssignmentExpressionOperator {

	@Override
	public boolean canCalc(IType typeX, IType typeY) {
		return TypeUtils.equals(typeX, StringType.type) && TypeUtils.equals(typeY, IntType.type);
	}
	...
	public Val calculate(Val valX, Val valY) {
		return Val.of(StringType.type, ((String)valX.val).repeat((Integer)valY.val));
	}
